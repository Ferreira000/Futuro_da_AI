...
const perguntas = [
    {
      ...
      alternativas: [
        ...
        },
        {
          ...
          afirmacao: [
            "Quis saber como usar IA no dia a dia.",
            "Pensou que IA pode ajudar em tarefas da sua vida.",
            "Acredit que a IA vai lhe ajudar no futuro"
          ],
        },
      ],
    },
      ...
      alternativas: [
        ...
        },
        {
          ...
          afirmacao: [
            ...
            "Encontrou dificuldade em obter bom resultado com IA"
      ...
      alternativas: [
        {
          ...
          afirmacao: [
            ...
            "Estimula a utilização da IA nas tarefas diáreas"
          ]
        },
        {
          texto:
          ...
          afirmacao: [
            "Sua preocupação com as pessoas motivou a criar um grupo de estudos entre trabalhadores para discutir mei",
